...
## include/uvgrtp/util.hh — top-level includes (lines 12-23)
...
## include/uvgrtp/util.hh — `capture_frame_metadata` addition (lines 421-432)
...
## include/uvgrtp/media_stream.hh — STL includes (lines 3-15)
...
## include/uvgrtp/media_stream.hh — packet capture declarations (lines 294-323)
...
## src/media_stream.cc — STL includes (lines 28-37)
...
## src/media_stream.cc — packet capture methods (lines 664-706)
...
## src/formats/media.hh — include stack (lines 1-12)
...
## src/formats/media.hh — surface capture setter (lines 77-83)
...
## src/formats/media.cc — STL includes (lines 7-14)
...
## src/formats/media.cc — capture forwarding (lines 201-210)
...
## src/frame_queue.hh — header includes (lines 3-15)
...
## src/frame_queue.hh — capture callback type (lines 87-95)
...
## src/frame_queue.hh — capture API declarations (lines 119-131)
...
## src/frame_queue.hh — private helpers (lines 178-191)
...
## src/frame_queue.hh — capture state members (lines 196-218)
...
## src/frame_queue.cc — header includes (lines 10-22)
...
## src/frame_queue.cc — capture metadata initialization (lines 344-361)
...
## src/frame_queue.cc — paced send loop (lines 368-394)
...
## src/frame_queue.cc — non-paced send handling (lines 404-423)
...
## src/frame_queue.cc — helper definitions (lines 482-543)
...
## examples/CMakeLists.txt — trailing newline (lines 56-66)
